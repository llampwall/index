...
export default class Post extends Component {
  ...
  displayMedia = () => {
    if (this.props.post.type == 'image' && this.props.post.image_url != null) {
      this.image = this.props.post.image_url
        console.log(this.image)
        
        return (
          <Palette src={this.image}>
            {({ data, loading, error }) => (
              <div className="post-media" style={{
                  ...
                  boxShadow: `0 20px 0px 0px ${data.vibrant}, 0 -20px 0px 0px ${data.vibrant}, 12px 0 15px 10px red, -12px 0 15px 10px red`}}>
                    Hey
              </div>
            )}
          </Palette>
